          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-2xl mx-auto bg-white/70 backdrop-blur-sm rounded-xl shadow-sm border border-gray-100 p-8">
              <div className="flex flex-col items-center justify-center text-center mb-8">
                ...
                <p className="text-nexus-darkGray">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <label
                      htmlFor="name"
                      className="block text-sm font-medium text-nexus-darkGray mb-1"
                    >
                      Name
                    </label>
                    <input
                      type="text"
                      id="name"
                      className="w-full px-4 py-2 rounded-md border border-gray-200 focus:outline-none focus:ring-2 focus:ring-[#1E40AF]"
                    />
                  </div>
                  <div>
                    <label
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#1E40AF] via-[#EA384C] to-[#000000] text-white py-3 rounded-md font-medium hover:opacity-90 transition-opacity"
                >
                  Send Message
                </button>
              </form>
        ...
        <footer className="bg-white/80 backdrop-blur-sm py-12 px-6 border-t border-gray-100">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <Logo size="md" />
              <p className="text-nexus-darkGray mt-2">
            ...
            <div className="flex gap-8">
              <a
                href="#services"
                className="text-nexus-darkGray hover:text-[#1E40AF] transition-colors"
              >
                Services
              </a>
              <a
